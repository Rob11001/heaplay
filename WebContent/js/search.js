...
function createDiv(bean,container,typeOfSearch) {
	...
	const playlistDiv= typeOfSearch == "playlist" ? "<div class='playlist'><div class='playlist-image'><img alt='Non trovata' src='/heaplay/getImage?id=" + (bean.tracks.length > 0 ? bean.tracks[0].id : -1) + "'></div><div class='playlist-content'><span class='author'><a href='/heaplay/user/" + bean.authorName + "'>" + bean.authorName + "</a></span><br/><span class='playlist-name'><a href='/heaplay/user/" + bean.authorName + "/playlist/" + bean.name + "'>" + bean.name + "</a></span></div></div>" : "";
