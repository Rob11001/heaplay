...
function createDiv(bean,container,typeOfSearch) {
	...
	const playlistDiv= typeOfSearch == "playlist" ? "<div class='playlist'><a href='/heaplay/user/"+bean.authorName+"/playlist/"+bean.name+"'><img width='100px' alt='Non trovata' src='/heaplay/getImage?id=" + bean.tracks[0].id + "'></a><div class='playlist-info'><span><a href='/heaplay/user/"+bean.authorName+"/playlist/"+bean.name+"'>"+bean.name+"</a></span><br><span><a href='/heaplay/user/"+bean.authorName+"'> di "+bean.authorName+"</a></span></div></div>" : "";
	const commentDiv ="<div class='comment'><h3><a href='/heaplay/user/"+bean.author+"'>"+bean.author+"</a></h3><span class='comment-body'>"+bean.body+"</span></div>";
