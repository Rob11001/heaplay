...
<div class="page-header">
	<div class="relative-container" onmouseenter=<%=(currentUser == null || currentUser.getId() != userPage.getId()) ? "''": "showConfirmButton($('#srcImg'))"%> onmouseleave=<%=(currentUser == null || currentUser.getId() != userPage.getId()) ? "''" : "hideConfirmButton($('#srcImg'))"%>>
